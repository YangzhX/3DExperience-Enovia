...
public class textFileToExcel {
	...
	private static String PPReportWorkBookName = "SX-Validation-Local-PPReport"+"-"+strDate;
...
//            	mlInput1.add(mTemp1);
            ...
            List mlReturn = processPPInfo.rearrangePPdata(mlInput);
            ListToExcel.ListWithMapToExcel(PPReportWorkBookName, SheetName, "C:\\Personal\\Work\\GE\\Series-X\\17x\\ValidationReports\\", PPReportcolumns, mlReturn);
//            processThumbnailInfo.rearrangeThumbnailData(mlInput, mlInput1);
    ...
    public static void writeToExcel(List<Map<?, ?>> mlInput) throws IOException {
        ...
        // Create a Sheet
        Sheet sheet = workbook.createSheet("5-16-18");
...
//						System.out.println("s3ShTemp3 >>>"+s3ShTemp3);
        ...
        FileOutputStream fileOut = new FileOutputStream("SX-Validation-QA1-5-16-18.xlsx");
...
//				System.out.println("DWG NAME - Single File :::"+(String)mTemp.get(DomainConstants.SELECT_NAME));
        ...
        // Write the output to a file
        FileOutputStream fileOut = new FileOutputStream("SX-Validation-DWG-QA1-5-16-18.xlsx");
        workbook.write(fileOut);
        fileOut.close();
        System.out.println("CLOSE");
